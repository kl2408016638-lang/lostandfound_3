        ...
        <div class="admin-nav-menu">
            ...
            <div class="submenu">
                ...
                <a href="admin_users.php" class="submenu-item" data-page="users">
                 ...
                 <a href="admin_messages.php" class="submenu-item" data-page="messages">
                    <div class="submenu-icon"><i class="fas fa-envelope"></i></div>
    ...
    <div class="admin-top-header">
        <div class="admin-page-title">
            ...
            $page_titles = [
                ...
                'admin_messages.php' => 'User Messages'
            ];
